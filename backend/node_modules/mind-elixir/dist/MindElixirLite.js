...
}, lt = (t) => t ? t.tagName === "ME-TPC" : !1, Lt = (t) => {
...
function qt(t) {
  ...
  return kt([
    { dom: E, evt: "pointerdown", func: S },
    { dom: E, evt: "pointermove", func: T },
    { dom: E, evt: "pointerup", func: D },
...
const nt = document, Ut = function() {
  ...
  if (e.icons && e.icons.length) {
    const n = P.createElement("span");
    n.className = "icons", n.innerHTML = e.icons.map((o) => `<span>${Yt(o)}</span>`).join(""), t.appendChild(n), t.icons = n;
  ...
  const e = P.createElement("me-children");
  return e.append(...t), e;
}, ee = function(t) {
  const e = P.createElement("me-tpc");
  return e.nodeObj = t, e.dataset.nodeid = "me" + t.id, e;
};
function Pt(t) {
  const e = P.createRange();
...
const ne = function(t) {
  ...
  border: ${r.border};
  border-radius:${r.borderRadius}; `, this.direction === 0 && (e.style.right = "0"), Pt(e), this.bus.fire("operation", {
    name: "beginEdit",
    obj: t.nodeObj
  ...
  const e = X.createElementNS(I, "svg");
...
function me(t) {
  t.container.append(pe(t)), t.container.append(ge(t));
}
const ye = function(t, e = !0) {
  this.theme = t;
  const o = {
...
const be = function(t) {
  ...
  return {
    ...
    cb: null,
    init(e, n) {
      this.cb = n, this.handleClear = this.handleClear.bind(this), this.handlePointerMove = this.handlePointerMove.bind(this), this.handlePointerDown = this.handlePointerDown.bind(this), this.destroy = kt([
...
const mt = function(t, e, n, o, s) {
  ...
  mt(this, t, e, o), this.bus.fire("operation", {
    name: "createArrow",
    obj: o
  });
}, _e = function(t) {
  rt(this);
  const e = { ...t, id: _() };
  mt(this, this.findEle(e.from), this.findEle(e.to), e), this.bus.fire("operation", {
    name: "createArrow",
    obj: e
  });
}, Ue = function(t) {
...
function en() {
  ...
  for (let e = 0; e < this.arrows.length; e++) {
    ...
    try {
      mt(this, this.findEle(n.from), this.findEle(n.to), n, !0);
    } catch {
    }
  }
...
function nn(t) {
  rt(this), t && t.labelEl && Ht(this, t.labelEl, t.arrowObj);
}
function on() {
...
const sn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  const e = _(), n = { ...t, id: e };
  yt(this, n), this.summaries.push(n), this.bus.fire("operation", {
    name: "createSummary",
    obj: n
  });
}, fn = function(t) {
  ...
  t && t.labelEl && Ht(this, t.labelEl, t.summaryObj);
...
const Mn = function(t = !1, e) {
  ...
  init(t) {
    ...
    t.direction !== void 0 && (this.direction = t.direction), this.changeTheme(t.theme || this.theme, !1), this.nodeData = t.nodeData, pt(this.nodeData), this.arrows = t.arrows || [], this.summaries = t.summaries || [], this.tidyArrow(), this.toolBar && me(this), this.layout(), this.linkDiv(), this.toCenter();
  },
  destroy() {
